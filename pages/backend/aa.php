      ...
      <div class="row text-center">
        ...
        <div class="col-lg-6 text-left">
                    ...
                    <select class="selectpicker" name=font_size>
                      <option value="12">12 <?php $_SESSION['font_size']=12; ?></option>
                      <option value="14">14 <?php $_SESSION['font_size']=14; ?></option>
                      <option value="16">16 <?php $_SESSION['font_size']=16; ?></option>
                      <option value="18">18 <?php $_SESSION['font_size']=18; ?></option>
                      <option value="20">20 <?php $_SESSION['font_size']=20; ?></option>
                      <option value="22">22 <?php $_SESSION['font_size']=22; ?></option>
                      <option value="24">24 <?php $_SESSION['font_size']=24; ?></option>
                      <option value="26">26 <?php $_SESSION['font_size']=26; ?></option>
                      <option value="28">28 <?php $_SESSION['font_size']=28; ?></option>
                      <option value="36">36 <?php $_SESSION['font_size']=36; ?></option>
                      <option value="48">48 <?php $_SESSION['font_size']=48; ?></option>
                      <option value="72">72 <?php $_SESSION['font_size']=72; ?></option>
                    </select>
        </div>
      </div>
      <br />
